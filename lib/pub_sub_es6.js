  ...
  return function on(target, name, descriptor) {
    ...
    target.componentDidMount = function () {
      ...
      if (this._pub_sub_es6_internal_uids) {
        this._pub_sub_es6_internal_uids = [].concat(_toConsumableArray(this._pub_sub_es6_internal_uids), [uid]);
      } else {
    ...
    target.componentWillUnmount = function () {
      this._pub_sub_es6_internal_uids && this._pub_sub_es6_internal_uids.map(function (uid) {
